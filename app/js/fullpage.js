(function(root, window, document, factory, undefined) {
    ...
    function initialise(containerSelector, options) {
        ...
        function forMouseLeaveOrTOuch(eventName, allowScrolling) {
            ...
            document.addEventListener(eventName, onMouseEnterOrLeave, !0)
        }
        ...
        function addVerticalNavigation() {
            ...
            for (var i = 0; i < $(SECTION_SEL).length; i++) {
                ...
                if (typeof tooltip !== 'undefined' && tooltip !== '') {
                    li += '<div class="' + SECTION_NAV_TOOLTIP + ' fp-' + options.navigationPosition + '">' + tooltip + '</div><span class="fp-tooltip left">' + '0' + order + "</span>"
                }
                li += '</li>'
            }
        ...
        function moveSlide(direction, section) {
            ...
            slideMoving = !0 && !FP.test.isTesting;
        ...
        function fireCallback(eventName, v) {
            ...
            if (!options.v2compatible) {
                ...
                if (options[eventName].apply(eventData[Object.keys(eventData)[0]], toArray(eventData)) === !1) {
                    return !1
                }
            } else {
                if (options[eventName].apply(eventData[0], eventData.slice(1)) === !1) {
                    return !1
                }
            }
            return !0
            ...
            if (options.onSlideLeave) {
                if (!v.localIsResizing && v.xMovement !== 'none') {
                    if (isFunction(options.onSlideLeave)) {
                        if (fireCallback('onSlideLeave', v) === !1) {
                            slideMoving = !1;
                            return
                        }
                    }
        ...
        function removeMouseWheelHandler() {
            if (document.addEventListener) {
                document.removeEventListener('mousewheel', MouseWheelHandler, !1);
                document.removeEventListener('wheel', MouseWheelHandler, !1);
                document.removeEventListener('MozMousePixelScroll', MouseWheelHandler, !1)
            } else {
        ...
        function addMouseWheelHandler() {
            ...
            if (support == 'DOMMouseScroll') {
                document[_addEventListener](prefix + 'MozMousePixelScroll', MouseWheelHandler, !1)
            } else {
                document[_addEventListener](prefix + support, MouseWheelHandler, !1)
            }
        }
        ...
        function destroy(all) {
            ...
            ['mouseenter', 'touchstart', 'mouseleave', 'touchend'].forEach(function(eventName) {
                document.removeEventListener(eventName, onMouseEnterOrLeave, !0)
            });
            clearTimeout(afterSlideLoadsId);
            clearTimeout(afterSectionLoadsId);
            if (all) {
